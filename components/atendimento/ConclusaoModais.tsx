...
function IconReturn({ className }: { className?: string }) {
  return (
    <svg className={className ?? "h-[15px] w-[15px]"} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden>
    ...
    <ModalBackdrop onClose={onClose}>
      <div className="min-h-[310px] px-6 pb-10 pt-10 pr-14 sm:px-6 sm:pr-16">
        <h2 className="text-2xl font-bold leading-[1.5] text-[#0f2e4b]">
          Você confirma que os dados e documentos foram verificados e estão de acordo para a Renovação de CONDUTAX?
        </h2>
        <p className="mt-2 text-[14px] leading-[1.5] text-[#3f444d]">
          Pressione &quot;PROTOCOLAR&quot; para prosseguir com a aprovação da solicitação. Caso deseje verificar novamente, pressione
          &quot;Retornar&quot;.
        </p>
...
export function ModalIndeferir({
  open = true,
  onClose,
  onIndeferir,
  onRetornar,
  ...
  return (
    <ModalBackdrop onClose={onClose}>
      <div className="min-h-[310px] px-6 pb-10 pt-10 pr-14 sm:px-6 sm:pr-16">
        <h2 className="text-2xl font-bold leading-[1.5] text-[#0f2e4b]">
          Você confirma que os dados e/ou documentos enviados foram verificados e NÃO estão de acordo para a Renovação de CONDUTAX?
        </h2>
        <p className="mt-2 text-[14px] leading-[1.5] text-[#3f444d]">
          Pressione &quot;Indeferir&quot; para confirmar a reprovação da solicitação. Caso deseje solicitar novos documentos, pressione
          &quot;SOLICITAR NOVOS DOCUMENTOS&quot;, ou pressione &quot;Retornar&quot; para voltar à tela anterior.
        </p>
...
export function ModalConclusaoDeferida({
  open = true,
  onClose,
  onProsseguir,
}: {
    ...
    <ModalBackdrop onClose={onClose}>
      <div className="flex min-h-[415px] flex-col items-center px-4 py-11 text-center sm:px-28">
        ...
        <h2 className="mt-12 max-w-[790px] text-2xl font-bold leading-[1.5] text-[#0f2e4b]">
          Renovação de CONDUTAX deferida com sucesso!
        </h2>
...
export function ModalConclusaoReprovada({
  open = true,
  onClose,
  onProsseguir,
}: {
  ...
  return (
    <ModalBackdrop onClose={onClose}>
      <div className="flex min-h-[415px] flex-col items-center px-4 py-11 text-center sm:px-28">
        ...
        <h2 className="mt-12 max-w-[790px] text-2xl font-bold leading-[1.5] text-[#0f2e4b]">
          Solicitação de Renovação de CONDUTAX reprovada.
        </h2>
        <p className="mt-2 max-w-[790px] text-[14px] leading-[1.5] text-[#3f444d]">
          Pressione &quot;Prosseguir&quot; para retornar a tela de seleção de atendimento.
        </p>
...
export function ModalConclusaoSolicitacao({
  open = true,
  onClose,
  onProsseguir,
}: {
